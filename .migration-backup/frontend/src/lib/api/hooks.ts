...
export function useProfileQuery() {
  ...
  return useQuery({
    ...
    queryFn: () => api.getProfile(token as string),
  });
}
...
export function useStatsQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getStats(token as string),
  });
}
...
export function useBalanceQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getBalance(token as string),
  });
}
...
export function useUsageQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getUsage(token as string),
  });
}
...
export function useTransactionsQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getTransactions(token as string),
  });
}
...
export function useApiKeysQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getApiKeys(token as string),
  });
}
...
export function useGenerateApiKeyMutation() {
  ...
  return useMutation({
    mutationFn: (payload: { name: string; expiresInDays?: number }) =>
      api.generateApiKey(token as string, payload.name, payload.expiresInDays),
    onSuccess: () => {
...
export function useAdminAnalyticsQuery() {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.getAdminAnalytics(token as string),
  });
}
...
export function useAdminModelsQuery(params: { page: number; pageSize: number; search?: string; isActive?: string }) {
  ...
  const token = useToken();
  return useQuery({
    queryKey: queryKeys.adminModels(params),
    enabled: Boolean(token),
    queryFn: () => api.listAdminModels(token as string, params),
  });
}
...
export function useUpdateAdminModelMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: Record<string, unknown> }) =>
      api.updateAdminModel(token as string, id, payload as any),
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["adminModels"] }),
  });
}
...
export function useAdminUsersQuery(params: {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.listAdminUsers(token as string, params),
  });
}
...
export function useUpdateAdminUserMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: Record<string, unknown> }) =>
      api.updateAdminUser(token as string, id, payload as any),
...
export function useAdminTransactionsQuery(params: {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.listAdminTransactions(token as string, params),
  });
}
...
export function useAdminPackagesQuery(params: { page: number; pageSize: number; search?: string; status?: string }) {
  ...
  const token = useToken();
  return useQuery({
    queryKey: queryKeys.adminPackages(params),
    enabled: Boolean(token),
    queryFn: () => api.listAdminPackages(token as string, params),
  });
}
...
export function useUpdateAdminPackageMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: Record<string, unknown> }) =>
      api.updateAdminPackage(token as string, id, payload as any),
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["adminPackages"] }),
  });
}
...
export function useAdminPromocodesQuery(params: { page: number; pageSize: number; search?: string; isActive?: string }) {
  ...
  const token = useToken();
  return useQuery({
    queryKey: queryKeys.adminPromocodes(params),
    enabled: Boolean(token),
    queryFn: () => api.listAdminPromocodes(token as string, params),
  });
}
...
export function useUpdateAdminPromocodeMutation() {
  ...
  return useMutation({
    mutationFn: ({ id, payload }: { id: string; payload: Record<string, unknown> }) =>
      api.updateAdminPromocode(token as string, id, payload as any),
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ["adminPromocodes"] }),
  });
}
...
export function useAdminLogsQuery(params: {
  ...
  return useQuery({
    ...
    enabled: Boolean(token),
    queryFn: () => api.listAdminLogs(token as string, params),
  });
}
