...
export class ApiClient {
  ...
  async listAdminModels(
    token: string,
    params: { page: number; pageSize: number; search?: string; isActive?: string },
  ): Promise<Paginated<AdminModel>> {
    const query = buildQuery({
      page: params.page,
      page_size: params.pageSize,
      search: params.search,
      is_active: params.isActive === "all" ? undefined : params.isActive,
    });
  ...
  async listAdminUsers(
    token: string,
    params: { page: number; pageSize: number; search?: string; planTier?: string; isActive?: string },
  ): Promise<Paginated<AdminUser>> {
    const query = buildQuery({
      page: params.page,
      page_size: params.pageSize,
      search: params.search,
      plan_tier: params.planTier === "all" ? undefined : params.planTier,
      is_active: params.isActive === "all" ? undefined : params.isActive,
    });
  ...
  async createAdminPackage(
    token: string,
    payload: Omit<AdminPackage, "id" | "created_at" | "updated_at">,
  ...
  async createAdminPromocode(
    token: string,
    payload: Omit<AdminPromocode, "id" | "current_uses" | "created_at" | "updated_at">,
